...
**Institutions** that maintain their own publication repositories should ensure that they are included in the sources searched by unpaywall (https://unpaywall.org/sources) and encourage staff to self-archive where possible. Several herbaria are associated with the publication of botanical journals; these include many nomenclatural acts and the botanical community would benefit from a move to an OA publishing model to faciltate access.
